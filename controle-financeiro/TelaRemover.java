...
public class TelaRemover extends Tela{
    ...
    protected void defineConteudo() {
        ...
        img.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/remover.png")));
        ...
        JtextFieldOnlyNumber dadoCpfCnpj = new JtextFieldOnlyNumber(9, 14);

        String codCompras[] = {"ID Compra", "ID Transação"};
        JComboBox cbCompra = new JComboBox(codCompras);  
        JTextField idCompra = new JTextField(8);
