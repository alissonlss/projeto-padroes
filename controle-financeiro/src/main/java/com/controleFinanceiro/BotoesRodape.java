...
public class BotoesRodape {
    ...
    public void montarRodape(){
        ...
        voltar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/controleFinanceiro/imagens/voltar.png"))); 
        ...
        inicio.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/controleFinanceiro/imagens/inicio.png"))); 
